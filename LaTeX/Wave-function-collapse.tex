...
Andersrum hingegen wenn statt einem lokalen und stationären {(siehe Abbildung 3.2)} Input ein Foto verwendet wird,
dann würden die anderen Synthesemethoden passendere Ergebnisse liefern im Gegensatz zur Model Synthese und WFC.
Es sei erwähnt das der Input für WFC nicht \glqq strikt\grqq{} eine Textur wie in Abbildung 3.2 {(b)} sein muss.
Sie sollte allerdings Selbstähnlichkeit haben und nur wenige unterschiedliche Pixelfarben verwenden.\\
