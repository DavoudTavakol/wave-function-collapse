...
%MARKOV FELDER HIER IN DIESEM ABSCHNITT EINFÜGEN!
...
\footnote[1]{Dies ist nicht zwingend der fall für WFC. Dazu später mehr.}
...
Es sei erwähnt das der Input für WFC nicht \say{strikt} eine Textur wie in Abbildung 2.2 {(b)} sein muss.
...
\footnote[2]{Maxim Gumin’s erster WFC tweet \say{Procedural generation from a single
...
J. Parker zufolge benutzt er das Simple Tile Model für den Skatepark. \footnote[3]{persönliche Kommunikation, 23. Mai 2023}
...
Overlapping Model für plattformartige Situationen, in denen man eher eine Art Markow-Kette für die Größe der Features haben möchte.
\footnote[3]{persönliche Kommunikation, 23. Mai 2023}}\\
