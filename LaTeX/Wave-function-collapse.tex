...
Um solche Inhalte mit vordefinierten Parametern zu erstellen werden vor allem zwei Methoden zur Generierung verwendend.
AI's {(Künstliche Intelligenzen)} wie ChatGPT und Algorithmen.
Der Vorteil von solchen Tools ist es, das diese in kürzester Zeit qualitative Resultate Generieren können und auch wie oben erwähnt vordefinierte Parameter als Input erhalten können,
...
Zuerst werden gängige nicht interaktive Textursynthesen wie die Pixel basierende Textursynthese, Pyramid basierende Textursynthese und der Patch basierende Textursynthese erklärt.
Daraufhin wird auf Constraint-Satisfaction-Problem eingegangen und die Eigenschaft vom WFC Algorithmus solche Probleme zu lösen und
anhand von Sudoku wird im Detail die Funktionsweise von CSP's selbst aufgezeigt.
Wave-Function-Collapse als Algorithmus für Procedural-Content-Generation...
...
\say{Der zukünftige Zustand des Prozesses ist nur durch den aktuellen Zustand bedingt und wird nicht durch vergangene Zustände beeinflusst. {[18]}}
