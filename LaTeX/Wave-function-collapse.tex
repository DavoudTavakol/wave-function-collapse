...
%Diese Zeilen noch Umschreiben
Horswill und Foged [14] beschreiben eine "schnelle" Methode, um ein Leveldesign mit Inhalten zu füllen, die eine starke Spielbarkeit garantieren.
Ihr Algorithmus basiert auf Backtrackingsearch mit (AC3) Constraint Propagation. Obwohl dieser Algorithmus nur geringe Anforderungen an Prozessor- und Speicherressourcen stellt,
wird erwartet, dass er von Programmierern verwendet werden kann, die zumindest mäßige Kenntnisse im Design von Suchalgorithmen haben.
%
...
Grund für die große Beliebtheit dafür ist nicht nur die bereits erwähnten Pixelgenauigkeit, sondern auch die live Generierung des Outputs selbst.
