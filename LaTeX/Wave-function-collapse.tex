...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width=1\linewidth]{images/proc-skater.png}}%
    \caption{Level generierung in \textit{Proc Skater 2016} {[15]}}%
\end{figure}

Eine weitere Implementierung von WFC ist \textit{Caves of Qud} entwickelt von Freehold Games.
