...
\begin{figure}[H]
    ...
    \caption{
        ...
        Wenn der Algorithmus bereits die möglichen Patches der benachbarten Zellen ausgewertet hat, dann werden die Zellen mit allen verwendbaren Patches eingefärbt
