...
Dieser Algorithmus basierend auf Backtrackingsearch mit Constraint Propagation %Propagation noch erklären?
stellt zwar geringe Anforderungen an Prozessor- und Speicherressourcen, allerdings wird erwartet, das er von Programmierern verwendet werden die sich wenigstens mäßig mit Suchalgorithmen und Design auskennen.
