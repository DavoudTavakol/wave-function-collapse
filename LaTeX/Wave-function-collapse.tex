...
Dadurch erhält man keine "sauberen" Übergänge, und die einzelnen Blöcke sind klar erkennbar. {(siehe Abb. 4.1)}
...
%TODO PDF von {[8] Punkt IV} lesen und in diesem abschnitt einarbeiten und rest umschreiben!
