...
\begin{figure}[H]
    \centering
    \subfloat[][]{\includegraphics[width=0.4\linewidth]{Textur-nicht-stationärlokal-2.JPG}}%
    \qquad
    \subfloat[][]{\includegraphics[width=0.4\linewidth]{Textur-stationärlokal-2.JPG}}%
...
\begin{figure}[H]
    \centering
    \subfloat[][]{\includegraphics[width=0.4\linewidth]{images/synthezising-pixel.JPG}}%
    \qquad
    \subfloat[][]{\includegraphics[width=0.4\linewidth]{images/Wall-sample.JPG}}%
...
Obwohk die Pyramid-Methode ist im Detail viel komplizierter ist,
werde ich sie hier nicht weiter Behandeln da sie für das weitere Verständniss dieser Arbeit keine relevanz hat und nur eine weitere Synthesemethode darstellen soll.

\section{Patch basierende Textursynthese}

Die Patch-Based Textursynthese ist gewissermaßen eine Erweiterung der Pixel basierende Textursynthese.
Hier wird statt einem Pixelabgleich direkt ganze Felder \textit{(Patches)} verglichen und generiert.
