...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\linewidth]{images/collapse-cells.JPG}
    \end{figure}
...
Das hat den Vorteil das die Patches ganz einfach aus dem Input errechnet werden können und der Output sieht dem Input ähnlicher da die Patches enger aneinander liegen.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/red-maze.jpg}%
    \caption{4 x 4 Pixel Red-Maze Beispiel Input}%
\end{figure}
