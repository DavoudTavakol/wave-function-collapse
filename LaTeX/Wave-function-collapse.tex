...
\begin{figure}[H]
    \centering
    \subfloat[][]{\includegraphics[width=0.4\linewidth]{images/pyramid-noise.JPG}}%
    \qquad
    \subfloat[][]{\includegraphics[width=0.4\linewidth]{images/pyramid-input.JPG}}%
    \qquad
    \subfloat[][]{\includegraphics[width=0.4\linewidth]{images/pyramid-matching.JPG}}%
...
% TODO: Nächster Abschnitt. WFC overlapping / tile und vergleich zu paul merrells modell synthese. Siehe video https://www.youtube.com/watch?v=zIRTOgfsjl0&t=1s&ab_channel=DVGen
...
\begin{figure}[H]
    ...
    \caption{(a) Input Struktur, (b) Alexei A. Efros and Thomas K. Leung 1999, (c) Kwatra et al., 2005}%
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{(a) Input Struktur, (b) Alexei A. Efros and Thomas K. Leung, (c) Paul Merrell Model Synthese}%
\end{figure}

%beispiel textur aufteilung. overlapping und tiled vorteile nachteile etc.
