...
Dadurch lassen sich mit beiden Algorithmen fehlerfreie Systeme automatisch Herstellen die gegebenenfalls Interaktiv verwendet werden können,
da wir absolute Kontrolle über den Input haben und wie dieser Verarbeitet wird.
