...
Hier werden statt Pixel gleich direkt ganze Felder \textit{(Patches)} verglichen und generiert.
...
Ein Problem der Patch-Based Synthese im Vergleich zur Pixel-Based ist das hier die neuen Patches sich mit bereits vorhandenen Patches überschneiden. {([8])}
