...
Hierbei werden aus dem Input-Image mehrere Output-Images in verschiedenen Auflösungen mithilfe von Glättung und Downsampling generiert {(siehe Abbildung 2.5 (a))}. {[AAA][EEE]}
\newline
...
sodass die Stichproben gleichmäßig auf dem Intervall {[0, 1]} verteilt sind.{[AAA][GGG]}
\newline
...
Gerade bei stationären Texturen erreicht diese Methode gute Ergebnisse.{[AAA]}
...
\begin{figure}[H]
    ...
    \caption{(a) Zufällige Patch Anordnung, (b) Patches eingeschränkt durch Nachbarn, (c) Minimal Fehler Randschnitt. Nach Alexei A. Efros and Thomas K. Leung. [BBB]}%
\end{figure}
...
dann wird die Entropie aller anderen Zellen angepasst. {[KKK]}
...
nennt sich Wave-Function-Collapse. {[MMM]}
...
\begin{figure}[H]
    ...
    \caption{(a) Output mit $N = 2$, (b) Output mit $N = 3$, (c) Output mit $N = 4$. Beispiele generiert mit Kchapelier's Overlapping Model. [OOO]}%
\end{figure}
...
\footnote[3]{Maxim Gumin’s erster WFC tweet \say{Procedural generation from a single
...
\footnote[4]{Persönliche Kommunikation, 23. Mai 2023}}
\newline
...
\footnote[5]{Aus Forums-Korrespondenz \url{https://forums.somethingawful.com/showthread.php?threadid=3563643&userid=68893&perpage=40&pagenumber=23\#post467126402}} {[HHH]}
...
{[EEE]} \url{https://de.wikipedia.org/wiki/Bildpyramide}\\

{[FFF]} \url{https://de.wikipedia.org/wiki/Punktoperator_(Bildverarbeitung)}\\

{[GGG]} \url{https://www.cns.nyu.edu/heegerlab/content/publications/Heeger-siggraph95.pdf}\\
...
{[KKK]} \url{https://en.wikipedia.org/wiki/Wave_function_collapse}\\

{[LLL]} \url{https://en.wikipedia.org/wiki/Constraint_satisfaction_problem}\\

{[MMM]} \url{https://en.wikipedia.org/wiki/Wave_function_collapse}\\
...
{[OOO]} \url{http://www.kchapelier.com/wfc-example/overlapping-model.html}\\
...
%[AAA] ERSETZTEN MIT DEN 3 vorgeschlagenen referenzen!
