...
Textursynthese kann auf verschiedenen Arten mit verschiedenen Algorithmen erfolgen.
Jedoch verfolgen alle Methoden zur Synthese das Grundprinzip größere Images mit aus kleinen Input Images zu generieren welche das Muster der kleineren konsistent verfolgt.
Dieser Effekt wird meistens dadurch erreicht, in dem aus dem kleineren Input Image zusätzlich kleiner Subimages generiert werden {(z.B. 5 x 5 Fenster)}. {[1]}
