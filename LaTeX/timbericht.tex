...
Diesen variablen sind Regeln, sogenannte \textit{(constraints)} Auferlegt sind die erfüllt werden müssen.
Jeder dieser variablen hat zu Beginn eine Superposition und kann damit jeden wert enthalten.
Aufgabe ist es einen Zustand \textit{(State)} zu finden in denen alle constraints erfüllt sind und jeder variable nur noch ein wert zugeordnet ist.
...
Immer, wenn ein Bereich eine wert zugeteilt wird, dann werden auch die benachbarten Bereiche damit beeinflusst.
